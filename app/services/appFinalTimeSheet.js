...
Task.createTimeEntry = function (id,emp_id,first_name,last_name,hours,location_code,task_code,foreman_id,date, result) {
    //id,Number(emp_id),first_name,last_name,time_in,location_code,task_code,foreman_id,
        sql.query("INSERT INTO final_time_sheet (emp_id, first_name, last_name,hours,location_code,task_code,foreman_id,date)" + 
        "values ("+emp_id+",?,'"+last_name+"','"+hours+"','"+location_code+"','"+task_code+"',"+foreman_id+",'"+date+"')", first_name,  function (err, res) {
        if (err) {
