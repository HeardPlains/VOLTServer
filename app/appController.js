...
exports.create_final_time_entry = function (req, res) {
  ...
  ActiveTimeSheet.getSheetFromFullName(
    req.body.first_name,
    req.body.last_name,
    function (err, task) {
      ...
      if (task != null) {
        var time_in = timeToDouble(task.time_in);
        var d = new Date();
        ...
        ActiveTimeSheet.remove(task.id, function (err, task) {
          console.log("controller");
          if (err) res.send(err);
          console.log("Remove User", task);
        });
      }
    }
  );
...
exports.create_active_time_entry = function (req, res) {
  ...
  var year = d.getFullYear();
  var date = month + "/" + day + "/" + year;
  EmployeeData.getGetEmployeeByFirstLast(
    req.body.first_name,
    req.body.last_name,
    function (err, emp) {
      console.log("controller");
...
exports.getGetEmployeeByFirstLast = function (req, res) {
  EmployeeData.getGetEmployeeByFirstLast(
    req.body.first_name,
    req.body.last_name,
    function (err, task) {
